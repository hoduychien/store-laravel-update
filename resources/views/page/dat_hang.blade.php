	...
	<div id="content">
		...
		<form action="{{route('dathang')}}" method="post" class="beta-form-checkout">
			...
			<div class="row" style="margin-top: -50px;">
				<h6 style="color: green">@if(Session::has('thongbao')){{Session::get('thongbao')}}@endif</h6>
							...
							<ul class="payment_methods methods">
								...
								<li class="payment_method_cheque">
									...
									<div class="payment_box payment_method_cheque" style="display: none;">
										...
										<br>- Chủ TK: Hồ Duy Chiến
										<br>- Ngân hàng AGB, Chi nhánh Quảng Trị
										<hr>
										<label for="payment_method_cheque">Thanh toán bằng ví ngân lượng </label>
										<hr style="margin-bottom: 1px;">
										<a href="#"><img src="https://www.nganluong.vn/css/newhome/img/button/pay-lg.png"border="0" /></a> 
									</div>						
								</li>
							</ul>
						</div>
